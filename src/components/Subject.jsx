...
export default function Subject(){
    const subjectList = [
        ...
        {
          id: 8,
          name: "FOUNDATIONS OF BLOCK CHAIN",
          icon: <FaBook />,
          color: "#464646",
          delay: 0.9,
        },
          ...
          <div className="container py-14 md:py-24">
            ...
            <div className="space-y-4 p-6 text-center max-w-[600px] mx-auto mb-5">
              ...
              <p className="font-semibold text-3xl">
                Find Online Tutor in Trending Courses
              </p>
            </div>
            {/* cards section */}
            ...
            <Link to="courses" className="bg-green-500 p-5 text-white rounded-3xl font-semibold" >All Courses</Link>
            </motion.div>
